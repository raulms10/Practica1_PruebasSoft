package practica1.constantes;

/**
 * Aquí se encuentran todos los mensajes que se muestran al usuario
 * @author Raúl, Alejandro
 */
public class Mensajes {
    
    public static String ENCABEZADO = "Practica #1 -> Triángulos y Cuadriláteros"
            + "\nPruebas de Software" 
            + "\nRaúl Martínez - Alejandro Castañeda";
    public static String OPCIONES_MENU = "\n>>> MENÚ"
            + "\nIngrese 1 para determinar el tipo de Triángulo"
            + "\nIngrese 2 para determinar el tipo de Cuadrilátero"
            + "\nIngrese 3 para terminar la aplicación"; 
    public static String SALIENDO = "Saliendo del sistema...";
    ...
    public static String DIGITE_NUEVAMENTE_LADO = "Digite nuevamente el valor del lado ";
    public static String LADO_1 = "#1";
    public static String LADO_2 = "#2";
    public static String LADO_3 = "#3";
    public static String LADO_4 = "#4";
    
    public static String DIGITE_OPCION = "Digite una opción: ";
    public static String DIGITE_NUEVAMENTE_OPCION = "Digite nuevamente una opción: ";
    ...
    public static String NO_CUADRILATERO = "pueden representar un TRAPEZOIDE";
